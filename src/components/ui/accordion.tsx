...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex flex-1 items-center justify-between gap-4 py-5 text-left text-base font-bold text-slate-950 transition-all hover:text-blue-700 [&[data-state=open]>svg]:rotate-180",
        className
      )}
      {...props}
    >
